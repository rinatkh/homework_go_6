...
// TODO: Drain (прочитать всё) должен получить значения до закрытия канала
// и сохранить их порядок. Nil-канал не нужно читать: для него верни
// пустой ненулевой слайс.
